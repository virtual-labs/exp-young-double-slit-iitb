...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(grating, new Chemistry.Point(900, 500), 165, 414, canvas);
    sq.name = 'Diffraction Grating';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(laser2, new Chemistry.Point(1500, 500), 230, 252, canvas);
    sq.name = 'Laser';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(diff_pattern, new Chemistry.Point(350, 500), 198, 352, canvas);
    // sq.name = 'Screen';
    scene.add(sq);
...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 1,
        question: "Select <span style='color: #018fc3'>Diffraction Grating</span>",
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Text('Diffraction Grating', new Chemistry.Point(800, 250), canvas),
