...
let screen_y1 = 0;
let screen_y2 = 0;
let current_color_code;
let tab_obj;
let obs_started = false;
function activity3() {
    pp.clearleftpannel();
    pp.clearrightpannel();
    pp.addoffcanvas(3);
    ...
    let off4main = document.getElementById('offcanvasRight4');
   ...
   <input disabled type='button' class='btn btn-primary' value="Add Reading" style="position: absolute;top: 40vw; left:43vw; margin-left: 3%; width: 10vw; font-size: 1.2vw;" id='act3_button' onclick='update_table();'>
    ...
    text_y = new Chemistry.Geo_Text('Y1 = 0', new Chemistry.Point(1620, 393), canvas);
    text_y2 = new Chemistry.Geo_Text('Y2 = 0', new Chemistry.Point(1620, 480), canvas);
    text_x = new Chemistry.Geo_Text('L = 5 m', new Chemistry.Point(1360, 290), canvas);
    ...
    first_up_ray = new Chemistry.Line(new Chemistry.Point(1080, d_y1), new Chemistry.Point(1500, 395), 1, 'red', canvas);
    first_up2_ray = new Chemistry.Line(new Chemistry.Point(1080, d_y2), new Chemistry.Point(1500, 395), 1, 'red', canvas);
    second_up_ray = new Chemistry.Line(new Chemistry.Point(1080, d_y1), new Chemistry.Point(1500, 395), 0.7, 'red', canvas);
    second_up2_ray = new Chemistry.Line(new Chemistry.Point(1080, d_y2), new Chemistry.Point(1500, 395), 0.7, 'red', canvas);
...
function set_adj() {
    ...
    let reading = (document.getElementById('lambda-reading'));
    let dsp = document.getElementById('dsp-L');
    if (adj_ele.value) {
