namespace Chemistry {
   ...
   export class DoubleArrowLine extends Geometry {
        ...
        constructor(x1: number, y1: number, x2: number, y2: number, color: string, arrowSize, canvas) {
            super();
            this.x1 = x1;
            this.x2 = x2;
            this.y1 = y1;
   ...
   export class Line extends Geometry {
    ...
    constructor(stpt1: Chemistry.Point, stpt2: Chemistry.Point, linewidth: number, color: string, canvas: HTMLCanvasElement) {
        super();
        this.x1 = stpt1.x;
        this.y1 = stpt1.y;
        this.x2 = stpt2.x;
